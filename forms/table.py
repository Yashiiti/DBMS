...
def table():
    if request.method == "POST":
        ...
        cursor.execute("select * from dine_book where dineid=%s and Guest=%s;",(room_id,x))
        ...
        if flag==1:
            ...
            return 'sorry no table booked with this id'
        return f'{room_id}'
    return render_template("table_service.html")
